...
| Application Software | systems-engineering-diagrams | Configuration Item | Python package providing the CLI and all generation/verification logic. | Find Subtree, Filter Tree, Generate Functional D2, Generate Functional Markdown, Generate Functional CSV, Generate Product D2, Generate Product Markdown, Generate Product CSV, Verify Function Allocation, Argument Parsing, File Processing |
| Application Software | PyYAML | Configuration Item | Python library for parsing and emitting YAML. | Load YAML |
