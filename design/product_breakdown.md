...
| Application Software | systems-engineering-cli | Configuration Item | Python module providing CLI argument parsing and file processing orchestration. | Argument Parsing, File Processing |
